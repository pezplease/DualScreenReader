...
/* TJpgDec API functions — prefixed jd3_ to avoid collision with esp32-camera's bundled tjpgd */
JRESULT jd3_prepare (JDEC* jd, size_t (*infunc)(JDEC*,uint8_t*,size_t), void* pool, size_t sz_pool, void* dev);
JRESULT jd3_decomp (JDEC* jd, int (*outfunc)(JDEC*,void*,JRECT*), uint8_t scale);
